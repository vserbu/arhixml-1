...
class MainWindowController implements Receiver, SucceededListener, ItemClickListener, ClickListener, ValueChangeListener, SplitterClickListener, Handler {
    ...
    public void uploadSucceeded(SucceededEvent event) {
        ...
        if (arhinet == null) {
            ...
            mainWindow.showNotification("Validacija učitane XML datoteke je neuspješna", model.getValidationErrorDetails(), Notification.TYPE_ERROR_MESSAGE);
    ...
    public void buttonClick(ClickEvent event) {
        ...
        if ("updateDetailsButton".equals(data)) {
            ...
            if (file == null) {
                ...
                mainWindow.showNotification("Nemoguće je generirati XML datoteku. Validacija korisničkih podataka je neuspjela.", model.getValidationErrorDetails(), Notification.TYPE_ERROR_MESSAGE);
