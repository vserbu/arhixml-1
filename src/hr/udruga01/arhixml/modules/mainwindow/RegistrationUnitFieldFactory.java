...
class RegistrationUnitFieldFactory implements FormFieldFactory {
    ...
    public RegistrationUnitFieldFactory() {
        ...
        holderIdValidator = new IntegerValidator("Šifra imatelja mora biti brojčana vrijednost");
        ...
        levelIdField.addValidator(new IntegerValidator("Šifra razine mora biti broj�ana vrijednost"));
        ...
        signatureField.addValidator(new IntegerValidator("Vrijednost signature mora biti brojčana vrijednost"));
        ...
        yearFromField.addValidator(new IntegerValidator("Vrijednost godine mora biti brojčana vrijednost"));
        ...
        yearToField.addValidator(new IntegerValidator("Vrijednost godine mora biti brojčana vrijednost"));

        materialField = new MaterialsCustomField("Građa");
        ...
        technicalUnitField = new TechnicalUnitsCustomField("Tehničke Jedinice");
